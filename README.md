...
Read (readFile): This method demonstrates data retrieval. It uses Files.readAllLines to pull content from the disk into a List, which is then iterated over for console display.
